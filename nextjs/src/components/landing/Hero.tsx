  ...
  return (
    <div>
      ...
      <section className="flex flex-col justify-center items-center mt-8">
        <h3 className="text-2xl font-bold text-gray-300 text-center">A Decentralized Game Built On TAIKO Blockchain</h3>
        <h3 className="text-lg font-bold text-gray-300 mb-2 text-center">« LIVE ON TESTNET & MAINNET »</h3>
        <Link href="https://taiko.xyz/" target="_blank">
          <Image
            src={taiko}
            width={64}
            height={64}
