        ...
        <div className="max-w-3xl mx-auto space-y-8">
            ...
            <CardContent className="p-6">
              ...
              <Accordion type="single" collapsible className="w-full">
                <AccordionItem value="item-1">
                  ...
                  <AccordionContent>
                    To start playing Shogun, connect your wallet, choose a general's name, and mobilize your initial
                    army. Once you're set up, you can begin attacking the Castle and defending, when you are the King.
                  </AccordionContent>
                </AccordionItem>
          ...
          <Card className="bg-gray-800 border-gray-700">
            <CardContent className="p-6">
              ...
              <Link href="https://jsmaxi.gitbook.io/shogun-taiko" passHref target="_blank">
